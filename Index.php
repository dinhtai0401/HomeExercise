...
$myStudents = new Students('Tai','Nguyen', 1997, 1997, ["PHP", "JavaScript", "Math"] , 5);
echo '<h2>Student</h2>';
...
echo '<br>';
echo 'The age of the student is '.' '.$myStudents->getAge();
echo '<br>';
...
echo '<br>';
echo 'The age of the teacher is '.' '.$myTeachers->getAge();
echo '<br>';
...
$myFirstStaff = new Staff('Phat','Phan', 1976, 1976, 'Caretaker');
...
echo '<br>';
echo 'The age of the staff is '.' '.$myFirstStaff->getAge();
echo '<br>';
echo 'The vacancy of the staff is'.' '.$myFirstStaff->getvacancy();
echo '<br>';

$mySecondStaff = new Staff('Lam','Pham', 2000, 2000, 'Cleaner');
...
echo '<br>';
echo 'The age of the satff is '.' '.$mySecondStaff->getAge();
echo '<br>';
echo 'The vacancy of the staff is'.' '.$mySecondStaff->getvacancy();
echo '<br>';
?>
